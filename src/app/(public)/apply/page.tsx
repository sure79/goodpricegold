...
export default function ApplyPage() {
  ...
  const [companyAddress, setCompanyAddress] = useState('울산광역시 남구 남중로108번길 36, 2층 202호')
  ...
  return (
    <div className="min-h-screen bg-zinc-50 py-8">
      <div className="max-w-2xl mx-auto px-4 sm:px-6">
        <div className="mb-8">
          <h1 className="text-2xl md:text-3xl font-bold text-gray-900">🪙 금니 매입 신청</h1>
          ...
          {!user && (
            <div className="mt-4 bg-yellow-50 border border-yellow-300 rounded-lg p-4">
              <p className="text-sm text-yellow-800">
                ℹ️ <strong>비회원도 신청 가능합니다!</strong> 신청서를 모두 작성한 후 제출 시 간편하게 회원가입하실 수 있습니다.
              </p>
            </div>
          )}
        </div>
        ...
        <div className="bg-white shadow-lg rounded-lg p-6 md:p-8">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="md:col-span-2">
                  ...
                  <textarea
                    ...
                    rows={3}
                    placeholder="크라운, 인레이, 브릿지 등 금니의 종류와 특징을 간단히 설명해주세요"
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-yellow-500"
                  />
            ...
            <div className="space-y-4">
              ...
              <label htmlFor="photo-upload" className="block border-2 border-dashed border-gray-300 rounded-lg p-6 cursor-pointer hover:border-yellow-400 hover:bg-yellow-50 transition-colors">
                <div className="text-center">
                  <div className="mx-auto h-12 w-12 text-gray-400 mb-4">
                    📷
                  </div>
                  <div className="text-sm text-gray-600 mb-4">
                    <span className="font-medium text-yellow-600">사진 선택</span>
            ...
            <div className="flex justify-end">
              <button
                ...
                className="px-8 py-3 bg-yellow-500 text-black font-bold rounded-md hover:bg-yellow-400 disabled:opacity-50 disabled:cursor-not-allowed transition-colors text-base md:text-lg"
              >
                {isSubmitting ? (
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg max-w-md w-full p-6">
            <div className="text-center mb-6">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">거의 다 완료했어요!</h3>
              <p className="text-sm text-gray-600">
                신청서를 제출하려면 간단한 회원가입이 필요합니다.
              </p>
            </div>

            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
              <p className="text-sm text-yellow-800">
                <strong>입력하신 정보는 저장됩니다</strong><br />
                회원가입 후 자동으로 신청이 완료됩니다.
              </p>
            </div>
            ...
            <div className="flex flex-col gap-3">
              <Link
                href="/signup"
                className="w-full bg-yellow-500 text-black py-3 px-4 rounded-md hover:bg-yellow-400 font-bold text-center transition-colors"
              >
                회원가입하고 신청 완료하기
              </Link>
              <Link
                href="/login"
                className="w-full bg-gray-600 text-white py-3 px-4 rounded-md hover:bg-gray-700 font-medium text-center transition-colors"
              >
                이미 회원이신가요? 로그인
              </Link>
              <button
                onClick={() => setShowSignupModal(false)}
                className="w-full bg-white text-gray-700 py-2 px-4 rounded-md hover:bg-gray-50 border border-gray-300 transition-colors"
              >
                취소
              </button>
            </div>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <div className="bg-white border border-blue-300 rounded p-3">
                    <p className="font-mono text-sm text-gray-800">010-8325-9774</p>
                    <button
                      onClick={() => copyToClipboard('010-8325-9774')}
                      className="mt-2 text-xs bg-blue-600 text-white px-3 py-1 rounded hover:bg-blue-700"
                    >
                      📋 번호 복사
                    </button>
