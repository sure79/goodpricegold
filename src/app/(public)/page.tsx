          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            {isLoggedIn ? (
              <>
                <Link
                  href="/apply"
                  className="bg-gray-900 text-white px-10 py-4 rounded-lg text-lg font-semibold hover:bg-gray-800 transition-all shadow-sm"
                >
                  지금 바로 매입 신청
                </Link>
                <Link
                  href={getDashboardLink()}
                  className="bg-white text-gray-900 px-10 py-4 rounded-lg text-lg font-semibold hover:bg-gray-50 transition-all border-2 border-gray-900"
                >
                  {user?.role === 'admin' ? '관리자페이지' : '마이페이지'}
                </Link>
              </>
        ...
        <div className="text-white py-12 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
              ...
              <div>
                ...
                <div className="space-y-2 text-sm text-gray-300">
                  ...
                  <p><strong>대표:</strong> 진병관</p>
                  <p><strong>주소:</strong> 울산광역시 남구 남중로108번길 36, 2층 202호</p>
                </div>
              </div>

              {/* 고객센터 */}
              <div>
                <h3 className="text-lg font-bold text-white mb-4">고객센터</h3>
                <div className="space-y-2 text-sm text-gray-300">
                  <p><strong>전화:</strong> 010-6622-9774</p>
                  <p><strong>이메일:</strong> support@geumnikkaebi.com</p>
              ...
              {/* 매입 안내 */}
              <div>
                <h3 className="text-lg font-bold text-white mb-4">매입 안내</h3>
                <div className="space-y-2 text-sm text-gray-300">
                  <p><strong>택배 발송 주소:</strong></p>
                  <p>울산광역시 남구 남중로108번길 36, 2층 202호</p>
                  <p>착한금니 감정팀 (010-6622-9774)</p>
                  <p className="mt-4"><strong>입금 계좌:</strong></p>
            ...
            <div className="border-t border-gray-800 pt-6 text-center">
              <p className="text-sm text-gray-400">&copy; 2024 착한금니(주). All rights reserved.</p>
            </div>
          </div>
        </div>
      </footer>
